/**
 * A coleta complementar feita numa máquina local.
 *
 * Esta é a contingência manual da rotina agendada: atualiza o repositório,
 * chama `executar.mjs` com as mesmas seis fontes e regras, e envia o que mudou.
 * O objetivo é reunir os comandos necessários numa execução guiada.
 *
...
console.log('\nColeta complementar local — ' + agoraEmSP() + '\n');
...
console.log('\n4. Enviando...');
const mensagem = 'Coleta de ' + agoraEmSP() + ' (execução local)';
