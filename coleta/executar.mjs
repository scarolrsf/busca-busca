...
/* Segunda via do STF, desligada por padrão (ver coleta/jurisprudencia-stf.mjs).
   Exige navegador de verdade e não alcança a fonte a partir do runner hospedado
   pelo GitHub — por isso só roda quando JURISPRUDENCIA_STF=1, numa execução à
   mão. É prova de vida da via com uma busca limitada, não coleta de conteúdo
   para o portal: o resultado bruto e a situação da tentativa ficam em
